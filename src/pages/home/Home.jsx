...
export default function Home() {
  ...
  return (
    <div className="px-4 py-8 md:px-6 md:py-12">
      <section
        className="relative mx-auto mb-12 max-w-site text-center md:mb-16"
      ...
      >
        ...
        <Reveal immediate delay={120}>
          <h1
            id="hero-title"
            className="text-gradient mb-4 text-[clamp(1.875rem,5vw,2.25rem)] font-bold tracking-tight"
          >
            Yisroel Krausz
          </h1>
        </Reveal>
        <Reveal immediate delay={240} variant="fade">
          <p className="mx-auto mb-6 max-w-copy text-base leading-relaxed text-text-muted md:mb-8 md:text-lg">
            I create responsive web applications and digital solutions for real clients,
            combining a strong frontend focus with broader software development skills.
          </p>
        </Reveal>
      ...
      <div className="mx-auto max-w-site">
        <ProjectSection
          ...
          title="Featured"
          subtitle="Selected web applications and API-driven products demonstrating frontend craft and broader development capability."
        ...
        <ProjectSection
          id="more-projects"
          title="More Projects"
          subtitle="Additional JavaScript and React builds covering practical UI patterns, application logic, and problem-solving."
