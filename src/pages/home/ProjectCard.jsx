...
export default function ProjectCard({ project, priority = false }) {
	return (
		<article
			className={`group/card glass-card flex h-full flex-col overflow-hidden transition-[transform,box-shadow,border-color] duration-base hover:-translate-y-1 hover:border-accent/20 hover:shadow-glow motion-reduce:hover:translate-y-0 ${
