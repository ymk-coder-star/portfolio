...
export const projects = [
  {
    ...
    description:
      'Built a React + Firebase project workspace with task boards, routing, live online users, and filtered views — integrating Firestore data, image uploading, date handling, and reusable UI components.',
    src: theDojo,
  ...
  },
  {
    ...
    tags: ['JavaScript', 'HTML', 'CSS', 'DOM Manipulation', 'GitHub Pages'],
  },
  {
    id: 'js-practice',
    title: 'JS Practice',
  ...
  },
  {
    ...
    tags: ['React', 'JavaScript', 'HTML', 'CSS', 'Create React App', 'GitHub Pages'],
  },
];
